		...
		<div class="footer_top">
        	<div class="w970 slideInLeft wow">  
                <div class="foot_nav FL"> 
                    ...
                    <a class="white" href="<?php  echo base_url('blog'); ?>">Blogs</a>
                    <a class="white" href="<?php  echo base_url('contactus'); ?>">Contact Us</a>
                </div>
                
                <div class="FL">
                    <p class="foothd">Call Today</p>
                    <?php  if(strstr($_SERVER['HTTP_USER_AGENT'],'iPhone')) {?><a class="numbr" href="tel:410746841">410-746-8415</a><?php  } else {?>
