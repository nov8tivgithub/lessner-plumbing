...
<?php
    for($i=0; $i<count($imgListArray); $i++){
     echo '<li><div class="img-preview"><a href="https://drive.google.com/uc?export=view&id='.$imgListArray[$i]['img_id'].'" data-imgkey = "'.$imgListArray[$i]['img_id'].'" data-lightbox="example-set"  class="multi-img"  ><img src="https://drive.google.com/uc?export=view&id='.$imgListArray[$i]['img_id'].'" class=""></a></div></li>';
    }  
?>
</ul>
</div>
