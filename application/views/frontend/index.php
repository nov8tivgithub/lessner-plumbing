...
.slide:first-child {
  background: url('../img/banner-slide3.jpg') no-repeat
    center top/cover;
}
.slide:nth-child(2) {
  background: url('../img/banner-slide1.jpg') no-repeat
    center top/cover;
}
.slide:nth-child(3) {
  background: url('../img/banner-slide2.jpg') no-repeat
    center top/cover;
}
...
<script type="text/javascript">stLight.options({publisher: "a1d9c125-d300-4ba0-ae33-83f35c123378", doNotHash: true, doNotCopy: false, hashAddressBar: false, onhover : true});</script>
   ...
   <? if(strstr($_SERVER['HTTP_USER_AGENT'],'iPhone')) {?><a class="fadeInLeft wow" href="tel:4107468415">Call Today 410-746-8415</a><? } else {?><p class="fadeInLeft wow" >Call Today 410&shy;-746-8415</p><? } ?>
    </div>
    ...
    <div id="section_two">
    	<div class="w970 abt_box ">
            <div class="w55 FL slideInLeft wow">
                ...
                <a  href="<? echo base_url('aboutus'); ?>" class="lp_lnk_btn">Read More</a>
            </div>
    ...
    <div id="section_three">
    	<div class="w970 abt_box text-center slideInLeft wow">
            ...
            <a href="<? echo base_url('service'); ?>" class="lp_lnk_btn">View Our Services</a>
		<div class="clear"></div>
        </div>
    <div class="clear"></div>
    </div>
    ...
    <div id="section_four" style="display:none"  >
    	<div class="w970 abt_box text-center" >
			...
			?>
                ...
                <div class="blog_box fadeInLeft wow">
                    <a class="vie_more" href="<? echo base_url('blogdetails/home/'.$cv['postkey']); ?>"></a>
                    <div class="blog_img">
                        <img src="<?php echo $cv['image'];?>" alt="blog image" />
                    </div>
                    <div class="blog_txt">
                     <a href="<? echo base_url('blogdetails/home/'.$cv['postkey']); ?>">   <h4 class="blog_tytl"><?php echo substr(strip_tags($cv['title']),0,20)."..."?></h4> </a> 
                        <p class="blog_para"><?php  echo substr(strip_tags($cv['description']),0,90)."..."?></p>
                        <p class="text-right"><?echo date("M", $cv['createdate'])." ";  echo date("d", $cv['createdate']).","." ";  echo date("Y", $cv['createdate']); ?></p>
                    </div>
                    <div class="share_box">
                        <a class="st_sharethis_custom share_away" st_url="<? echo base_url('blogdetails/'.$cv['postkey']); ?>" st_image="<? echo $cv['image'];?>" st_title="<? echo $cv['title']; ?>">Share</a>
                    </div>
                </div>
		<?
			endforeach;
		...
		?>			
            ...
            <div class="pd10">
                	<a class="lp_lnk_btn fadeInRight wow" href="<? echo base_url('blog'); ?>">Read More Blogs</a>
            </div>
    ...
    <div id="section_five">
    	...
    	<div class="areamap">
            ...
            <div class="pd10">
                	<a href="<? echo base_url('servicearea'); ?>" class="lp_lnk_btn">View all Service Area</a>
            </div>
            <div class="clear"></div>
            </div>
        </div>
    ...
    <div id="section_six">
    	<div class="w970 abt_box text-center slideInRight wow">
           ...
           <? if(strstr($_SERVER['HTTP_USER_AGENT'],'iPhone')) {?><a class="common_paragrph greshblu" href="tel:4107468415" style="display:inline !important;">410-746-8415</a><? } else{ ?>410&shy;-746-8415<?}?> to request information about our services or to provide feedback about our site.<!-- When you are finished, click the <?echo htmlspecialchars("'SEND'");?> button to send us your message.--></p>
            <div class="pd10">
            	<a href="<? echo base_url('contactus'); ?>" class="lp_lnk_btn">Contact Us</a>
            </div>
        </div>
    <div class="clear"></div>
    </div>
