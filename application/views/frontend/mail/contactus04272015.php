...
<table width='100%' border='0' cellspacing='0' cellpadding='0' align='center'  bgcolor='#E9E9E9'><tr><td valign='top'>
    ...
    <table width='700' border='0' cellspacing='0' cellpadding='5' align='center'>
        ...
        Please do not reply to this email. This mailbox is not monitored and you will not receive a response.
   		...
   		<tr><td align='center'><img src='<? echo base_url(); ?>images/logo.png'/></td></tr>
        <tr><td valign='top'>
...
<tr>
    ...
    <td style='font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#464646;' width='70%'> : <? echo ($this->input->post( 'firstname' )." ".$this->input->post( 'lastname' ));?></td>
  	</tr>
    ...
    <td style='font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#464646;' width='70%'>: <? echo $this->input->post( 'email' ); ?></td>
  	</tr>
    
  	<tr>
    <td style='font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#464646;' width='30%'>Phone</td>
    <td style='font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#464646;' width='70%'>: <? echo $this->input->post( 'phone' ); ?></td>
 	</tr>
...
<table width='100%' border='0' cellspacing='4' cellpadding='6'>
  ...
  <td style='font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#666666;'><? echo nl2br ($this->input->post( 'message' )); ?></td></tr>
</table>
              </td></tr>
              <tr><td valign='top' style='font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#464646; border-top:1px solid #D2D2D2;'>
              Thank you,<br>
              <strong>The Lessner Plumbing</strong>
              </td></tr>
              </table>        
        </td></tr>
        ...
        Copyright &copy; <? echo date('Y'); ?><span style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#000;"><a href='http://demo.icwares.com/clients/dev/lp/599/v1/' style='text-decoration:none; color:#11378b;'> lessnerplumbing.com.</a></span>, All Rights Reserved.<br />
