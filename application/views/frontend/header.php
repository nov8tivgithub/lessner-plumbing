...
<div class="wrapper">
    ...
    <div class="header pdTB5 bounceInDown wow">
            ...
            <div id="fulnav" class="FR pdR20 pdT30">
                ...
                <?php /* <a class="nav-button FL hvr-underline-from-center" href="<? echo base_url('blog'); ?>"><?php if($activeclass=="blog"): ?><span class="plum"></span><?php endif;?>BLOGS</a> */ ?>
      ...
      <div class="header-scrol">
        ...
        <div class="menu_overlay">
            ...
            <?php /* <a class="scrol_over hvr-underline-from-center" href="<? echo base_url('blog'); ?>"><?php if($activeclass=="blog"): ?><span class="plum"></span><?php endif;?>BLOGS</a> */ ?>
