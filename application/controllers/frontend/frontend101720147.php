<?php
  ...
  class Frontend extends CI_Controller {
      ...
      public function index() {
		  ...
		  $headerdata['keywords']	      = "Baltimore Metro Area, Residential, Commercial Plumbing Services, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service"; 
	...
	if(strstr($_SERVER['HTTP_USER_AGENT'],'iPhone') || strstr($_SERVER['HTTP_USER_AGENT'],'iPad'))
		...
		if(!empty($moreBlogs)){
	      ...
	      $headerdata['keywords']	      = "Baltimore Metro Area, categories, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service"; 
	  ...
	  if(!empty($tagids)){
       ...
       if ( $blogdat[ 'imgkey' ] != NULL ) {
		...
		$headerdata['activeclass']	  = "blog";
        $headerdata['title']	      = "Blogs: Lessner Plumbing : Licensed  & Insured Plumbing Services | Baltimore Metro Area | 410-746-8415"; 		  
	    $headerdata['keywords']	      = "Baltimore Metro Area, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service, categories,".$blogdat['title']; 
	    $headerdata['description']	  = "Baltimore Metro Area 410-746-8415";
	...
	if(strstr($_SERVER['HTTP_USER_AGENT'],'iPhone') || strstr($_SERVER['HTTP_USER_AGENT'],'iPad'))
	  ...
	  public function aboutus() {
	    ...
	    $headerdata['keywords']	      = "Who we are, what we offer, our guarantee, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service"; 
	  ...
	  public function contactus() {
	      ...
	      $headerdata['keywords']	      = "Lessner Services, Glyndon, MD, 410-746-8415, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service"; 
	  ...
	  public function polybutylenepipe() {
	      ...
	      $headerdata['keywords']	      = "Water service, poly pipe, interior, construction, Baltimore, corporation, temperature, replacement, protects, sale, emergency, projects warrantee, materials, labor, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service"; 
	  ...
	  public function draincleaning() {
	      ...
	      $headerdata['keywords']	      = "Drain cleaning services, tub drains, kitchen, garbage disposals, clogged shower drains, slow flowing drains,hydro jet sewer lines, sewer line repair, hydro jet, mechanical , snaking, preventive, maintenance, rooter, professional, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service"; 
