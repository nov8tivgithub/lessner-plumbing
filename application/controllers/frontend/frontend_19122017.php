  ...
  class Frontend extends CI_Controller {
	...
	if(strstr($_SERVER['HTTP_USER_AGENT'],'iPhone') || strstr($_SERVER['HTTP_USER_AGENT'],'iPad'))
	  ...
	  public function plumber( $location ){
	      ...
	      $headerdata['keywords']	      = "Plumber, plumber Reisterstown ,plumber Carroll county, sewer line replacement / repair, water line replacement/repair, ".$locations[$location].", Plumbing ".$locations[$location].""; 
