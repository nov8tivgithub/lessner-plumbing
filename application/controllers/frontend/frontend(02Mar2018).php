<?php
  ...
  class Frontend extends CI_Controller {
      ...
      public function index() {
		  ...
		  $headerdata['keywords']	      = "Baltimore Metro Area, Residential, Commercial Plumbing Services, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service, plumber Reisterstown ,plumber Carroll county, sewer line replacement / repair, water line replacement/repair."; 
	...
	if(strstr($_SERVER['HTTP_USER_AGENT'],'iPhone') || strstr($_SERVER['HTTP_USER_AGENT'],'iPad'))
		...
		if(!empty($moreBlogs)){
	      ...
	      $headerdata['keywords']	      = "Baltimore Metro Area, categories, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service, plumber Reisterstown ,plumber Carroll county, sewer line replacement / repair, water line replacement/repair."; 
	  ...
	  if(!empty($tagids)){
       ...
       if ( $blogdat[ 'imgkey' ] != NULL ) {
		...
		$headerdata['activeclass']	  = "blog";
        $headerdata['title']	      = "Blogs: Lessner Plumbing : Licensed  & Insured Plumbing Services | Baltimore Metro Area | 410-746-8415"; 		  
	    $headerdata['keywords']	      = "Baltimore Metro Area, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service, categories, plumber Reisterstown ,plumber Carroll county, sewer line replacement / repair, water line replacement/repair, ".$blogdat['title']; 
	    $headerdata['description']	  = "Baltimore Metro Area 410-746-8415";
	...
	if(strstr($_SERVER['HTTP_USER_AGENT'],'iPhone') || strstr($_SERVER['HTTP_USER_AGENT'],'iPad'))
	  ...
	  public function aboutus() {
	    ...
	    $headerdata['keywords']	      = "Who we are, what we offer, our guarantee, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service, plumber Reisterstown ,plumber Carroll county, sewer line replacement / repair, water line replacement/repair."; 
	  ...
	  public function contactus() {
          ...
          $this->form_validation->set_rules( 'message', 'Message', 'required|xss_clean' ); 
			  if ( $this->form_validation->run() === FALSE )
			  {
				...
				if ( $this->securimage->check( $this->input->post( 'captchacode' ) ) == false ) {
					  ...
					  $this->corefunctions->sendmail( ADMINEMAIL,'test@consult-ic.com','Customer Inquiry', $msg );
					  $data[ 'hasSucess' ] = TRUE;
	      ...
	      $headerdata['keywords']	      = "Lessner Services, Glyndon, MD, 410-746-8415, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service, plumber Reisterstown ,plumber Carroll county, sewer line replacement / repair, water line replacement/repair."; 
	  ...
	  public function service() {
	      ...
	      $headerdata['keywords']	      = "Drain Cleaning Services, Polybutylene Pipe Replacement, Water Service Repair, Construction groundwork, water treatment systems, drain cleaning, plumbing repairs,  sump pumps, utility work, waterlines, water lines, Excavation services, sewer lines, boilers, radiant, heat systems, gas lines, flood restoration services, septic systems, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service, plumber Reisterstown ,plumber Carroll county, sewer line replacement / repair, water line replacement/repair."; 
	  ...
	  public function polybutylenepipe() {
	      ...
	      $headerdata['keywords']	      = "Water service, poly pipe, interior, construction, Baltimore, corporation, temperature, replacement, protects, sale, emergency, projects warrantee, materials, labor, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service, plumber Reisterstown ,plumber Carroll county, sewer line replacement / repair, water line replacement/repair."; 
	  ...
	  public function draincleaning() {
	      ...
	      $headerdata['keywords']	      = "Drain cleaning services, tub drains, kitchen, garbage disposals, clogged shower drains, slow flowing drains,hydro jet sewer lines, sewer line repair, hydro jet, mechanical , snaking, preventive, maintenance, rooter, professional, Waterline replacement, Excavation, Plumber, Baltimore, Well pump replacement, Sewer line, Emergency Service, plumber Reisterstown ,plumber Carroll county, sewer line replacement / repair, water line replacement/repair."; 
	  ...
	  public function plumber( $location ){
		  ...
		  $headerdata['title']	          = "Plumber ".$locations[$location]." - Plumbing Services : Lessner Plumbing : Licensed  & Insured Plumbing Services | 410-746-8415"; 		  
	      $headerdata['keywords']	      = "Plumber, plumber Reisterstown ,plumber Carroll county, sewer line replacement / repair, water line replacement/repair, ".$locations[$location].", Plumbing ".$locations[$location].", Plumbers in ".$locations[$location].", Plumbers in ".$County[$location] . " County"; 
