...
class authorizenet extends CI_Model{
  ...
  var $gateway_url = "https://test.authorize.net/gateway/transact.dll";
   ...
   public function get_transactionid() {
	...
	public function get_approvalcode() {
      return $this->response['Approval Code'];
   }
   public function dump_fields() {
      ...
      echo "<h3>authorizenet->dump_fields() Output:</h3>";
   ...
   public function dump_response() {
      ...
      echo "<h3>authorizenet->dump_response() Output:</h3>";
      echo "<table width=\"95%\" border=\"1\" cellpadding=\"2\" cellspacing=\"0\">
            <tr>
